...
const useStyles = makeStyles()((theme) => ({
  root: {
    ...
    overflow: "hidden",
    backgroundImage:
      "radial-gradient(circle, rgba(238,174,174,0.8323704481792717) 0%, rgba(112,96,255,0.958420868347339) 100%)",
  ...
  form: {
    ...
    // background: "#0ebaf775",
    backgroundImage:
      "radial-gradient(circle, rgba(2,0,36,0) 0%, rgba(112,96,255,0.7727901158707865) 67%)",
    opacity: 1,
    padding: "25px",
    paddingBottom: 10,
