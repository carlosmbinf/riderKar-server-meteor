...
export default function EmpresasTable(option) {
  ...
  const titleBodyTemplate = (rowData) => {
    return (
      <React.Fragment>
        ...
        <Chip color="primary" label={rowData.title} />
      </React.Fragment>
    );
  };
  ...
  const latitudeBodyTemplate = (rowData) => {
    return (
      <React.Fragment>
        ...
        <Chip color="primary" label={`${rowData.latitude}`} />
      </React.Fragment>
    );
  };
  const longitudeBodyTemplate = (rowData) => {
    return (
      <React.Fragment>
        ...
        <Chip color="primary" label={`${rowData.longitude}`} />
      </React.Fragment>
    );
  };
